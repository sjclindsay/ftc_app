...
public class HardwareGrabber {
    ...
    public static float servoGrabberMinPosition = (float) 0.19;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        servoGrabber1.setPosition(0.65);
        servoGrabber2.setPosition(0.65);
